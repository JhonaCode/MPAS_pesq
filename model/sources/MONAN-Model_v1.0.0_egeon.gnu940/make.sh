...
export MONAN_SRC_DIR=${DIRhome}/sources/MONAN-Model_v1.0.0_egeon.gnu940
export MONAN_EXE_DIR=${DIRroot}/exec/MONAN-Model_v1.0.0_egeon.gnu940
export MONAN_EXE_PRE=${DIRroot}/../pre/
